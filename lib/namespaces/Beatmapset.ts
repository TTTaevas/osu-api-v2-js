...
export namespace Beatmapset {
  ...
  export namespace Event {
    ...
    export interface BeatmapOwnerChange
      extends WithUserid, WithOptionalBeatmapset {
    ...
    /** @group Beatmapset Status Change */
    export interface RemoveFromLoved
      extends WithUserid, WithOptionalBeatmapset {
    ...
    /** @group Beatmapset Status Change */
    export interface Disqualify
      extends WithUserid, WithOptionalBeatmapset, WithOptionalDiscussion {
      type: "disqualify";
    ...
    export interface NominationReset
      extends WithUserid, WithOptionalBeatmapset, WithDiscussion {
      type: "nomination_reset";
      comment: Comment.WithDiscussionidPostidNominatorsids;
    }

    /** @group Beatmapset Status Change */
    export interface NominationResetReceived
      extends WithUserid, WithOptionalBeatmapset, WithOptionalDiscussion {
    ...
    /** @group Discussion Change */
    export interface DiscussionRestore
      extends WithOptionalBeatmapset, WithOptionalDiscussion {
      type: "discussion_restore";
      comment: Comment.WithDiscussionidPostid;
    }

    /** @group Discussion Change */
    export interface DiscussionPostRestore
      extends WithOptionalBeatmapset, WithOptionalDiscussion {
    ...
    /** @group Discussion Change */
    export interface DiscussionPostDelete
      extends WithOptionalBeatmapset, WithOptionalDiscussion {
    ...
    /** @group Discussion Change */
    export interface DiscussionLock
      extends WithUserid, WithOptionalBeatmapset, WithOptionalDiscussion {
    ...
    /** @group Discussion Change */
    export interface DiscussionUnlock
      extends WithUserid, WithOptionalBeatmapset, WithOptionalDiscussion {
    ...
    /** @group Kudosu Change */
    export interface KudosuRecalculate
      extends WithOptionalBeatmapset, WithOptionalDiscussion {
    ...
    export async function getMultiple(
      ...
      return await this.request("get", ["beatmapsets", "events"], {
        ...
        user,
        min_date: from?.min_date?.toISOString(),
        max_date: from?.max_date?.toISOString(),
        types,
        ...config,
      });
    }
    ...
    export namespace Post {
      ...
      export async function getMultiple(
        ...
        return await this.request(
          ...
          { beatmapset_discussion_id: discussion, types, user, ...config },
        );
      }
    }
      ...
      export async function getMultiple(
        ...
        const discussion =
          typeof from?.discussion === "object"
            ...
            : from?.discussion;
        const user =
          typeof from?.vote_giver === "object"
            ? from.vote_giver.id
            : from?.vote_giver;
        const receiver =
          typeof from?.vote_receiver === "object"
            ? from.vote_receiver.id
            : from?.vote_receiver;
        ...
        return await this.request(
          ...
          {
            beatmapset_discussion_id: discussion,
            receiver,
            score,
            user,
            ...config,
    ...
    export async function getMultiple(
      ...
      const beatmapset_id =
        typeof from?.beatmapset === "object"
          ...
          : from?.beatmapset;
      const user_id =
        typeof from?.user === "object" ? from.user.id : from?.user;

      return await this.request("get", ["beatmapsets", "discussions"], {
        beatmapset_id,
        beatmapset_status: from?.status,
        message_types: filter?.types,
        only_unresolved: filter?.only_unresolved,
        user: user_id,
        ...config,
      });
    }
  ...
  export async function search(
    ...
    /** Categories */
    const s = query?.categories
      ? query.categories === "My Maps"
        ? "mine"
        : query.categories.toLowerCase()
      : undefined;
    ...
    /** Rank Achieved */
    const r = query?.rank_achieved
      ? query.rank_achieved
          .map((rank_achieved_value) => {
    ...
    return await this.request("get", ["beatmapsets", "search"], {
      ...
      r,
      played,
      cursor_string: query?.cursor_string,
    });
  }
  ...
  export async function lookup(
    this: API,
    beatmap: Beatmap["id"] | Beatmap,
  ): Promise<Beatmapset.Extended.Plus> {

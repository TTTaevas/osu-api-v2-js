...
export namespace Changelog {
  ...
  export namespace Build {
    ...
    export interface WithUpdatestreamsChangelogentries
      extends WithUpdatestreams, WithChangelogentries {}
    ...
    export async function lookup(
      this: API,
      changelog:
        | Changelog.UpdateStream["name"]
        | Changelog.Build["display_version"]
        | Changelog.Build["id"],
      message_formats: ("html" | "markdown")[] = ["html", "markdown"],
    ): Promise<Changelog.Build.WithChangelogentriesVersions> {
      return await this.request("get", ["changelog", changelog], {
    ...
    export async function getOne(
      this: API,
      stream: Changelog.UpdateStream["name"],
      build: Changelog.Build["display_version"],
    ): Promise<Changelog.Build.WithChangelogentriesVersions> {
  ...
  export namespace UpdateStream {
    ...
    export async function getAll(
      this: API,
    ): Promise<Changelog.UpdateStream.WithLatestbuildUsercount[]> {

import { API, Miscellaneous, User, WikiPage } from "../index.js"
...
export namespace Home {
	export namespace Search {
		 ...
		 */
		export async function getUsers(this: API, query: string, page: Miscellaneous.Page = 1): Promise<{data: User[], total: number}> {
		 ...
		 */
		export async function getWikiPages(this: API, query: string, page: Miscellaneous.Page = 1): Promise<{data: WikiPage[], total: number}> {
